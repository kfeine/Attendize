...
@section('title')
    ...
    @lang('manageevent_surveys.title')
@stop
        ...
        <div class="btn-toolbar" role="toolbar">
            <div class="btn-group btn-group btn-group-responsive">
                ...
                <button class="loadModal btn btn-success" type="button" data-modal-id="CreateQuestion"
                    ...
                    <i class="ico-question"></i> @lang('manageevent_surveys.add_question')
                </button>
            </div>

            <div class="btn-group btn-group btn-group-responsive">
                <button type="button" class="btn btn-success dropdown-toggle" data-toggle="dropdown">
                    <i class="ico-users"></i> @lang('manageevent_surveys.export_answers') <span class="caret"></span>
                </button>
                ...
                <div class="panel">
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <th>
                                @lang('manageevent_surveys.question_title')
                            </th>
                            <th>
                                @lang('manageevent_surveys.required')
                            </th>
                            <th>
                                @lang('manageevent_surveys.status')
                            </th>
                            <th>
                                @lang('manageevent_surveys.responses')
                            </th>
                            <th>
                                ...
                                <tr id="question-{{ $question->id }}" data-question-id="{{ $question->id }}">
                                    ...
                                    <td>
                                        ...
                                        <span style="font-size: 11px; color: #888;"
                                              class="muted">@lang('manageevent_surveys.tickets') {{implode(', ', array_column($question->tickets->toArray(), 'title'))}}</span>
                                    </td>
                                    <td>
                                        {{ $question->is_required ? __('manageevent_surveys.yes') : __('manageevent_surveys.no') }}
                                    </td>
                                    <td>
                                        <span class="label label-{{ $question->is_enabled ? 'info' : 'warning' }}">{{ $question->is_enabled ? __('manageevent_surveys.enabled') : __('manageevent_surveys.disabled') }}</span>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a class="btn btn-xs btn-primary enableQuestion" href="javascript:void(0);"
                                           ...
                                           data-id="{{ $question->id }}"
                                        >
                                            {{ $question->is_enabled ? __('manageevent_surveys.disable') : __('manageevent_surveys.enable') }}
                                        </a>
                                        <a data-id="{{ $question->id }}"
                                           ...
                                           class="deleteThis btn btn-xs btn-danger">
                                            @lang('manageevent_surveys.delete')
                                        </a>
