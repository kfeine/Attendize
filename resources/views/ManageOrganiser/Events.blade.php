...
@section('title')
    @parent
    @lang('manageorganiser_events.title')
@stop

@section('page_title')
    @lang('manageorganiser_events.name_events', ['name' => $organiser->name])
@stop
    ...
    <div class="col-md-9">
        <div class="btn-toolbar">
            <div class="btn-group btn-group-responsive">
                <a href="#" data-modal-id="CreateEvent" data-href="{{route('showCreateEvent', ['organiser_id' => @$organiser->id])}}" class="btn btn-success loadModal"><i class="ico-plus"></i> @lang('manageorganiser_events.create')</a>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        ...
        <div class="input-group">
            <input name="q" value="{{$search['q'] or ''}}" placeholder="@lang('manageorganiser_events.search')" type="text" class="form-control">
            ...
            <div class="col-md-3 col-xs-6">
                <div class="order_options">
                    <span class="event_count">
                      @lang('manageorganiser_events.event_count', ['count' => $organiser->events->count()])
                    </span>
                </div>
            </div>
