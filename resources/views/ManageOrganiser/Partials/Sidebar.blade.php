        ...
        <ul id="nav" class="topmenu">
            ...
            <li class="{{ Request::is('*customize*') ? 'active' : '' }}">
                <a href="{{route('showOrganiserCustomize', array('organiser_id' => $organiser->id))}}">
                    ...
                    <span class="text">@lang('manageorganiser_partials_sidebar.customize')</span>
                </a>
            </li>
        </ul>
    </section>
