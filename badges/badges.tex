...
\newcommand*{\SingleBadge}[1]{
  ...
  \begin{tikzpicture}
    ...
    % Name and origin
    \node [anchor=south] at (\BadgeWidth / 2, 1.8) {\textbf{\LARGE{\firstname~\lastname}}};
    \node [anchor=south] at (\BadgeWidth / 2, 1.1) {\large{\church}};
    \node [anchor=south] at (\BadgeWidth / 2, 0.6) {\large{\postalcode}};
  ...
  \begin{tikzpicture}
    ...
    \draw (0.8cm, \BadgeHeight - 4.3cm)
      rectangle ++(1.5cm, 1.3cm) node[text width=1cm,pos=0.5,align=center] {\ifthenelse{\equal{\mealA}{}}{}{JM}}
      rectangle ++(1.5cm,-1.3cm) node[text width=1cm,pos=0.5,align=center] {\ifthenelse{\equal{\mealB}{}}{}{JS}}
      rectangle ++(1.5cm, 1.3cm) node[text width=1cm,pos=0.5,align=center] {\ifthenelse{\equal{\mealC}{}}{}{VM}}
      rectangle ++(1.5cm,-1.3cm) node[text width=1cm,pos=0.5,align=center] {\ifthenelse{\equal{\mealD}{}}{}{VS}}
      rectangle ++(1.5cm, 1.3cm) node[text width=1cm,pos=0.5,align=center] {\ifthenelse{\equal{\mealE}{}}{}{SM}};
...
\begin{document}
  ...
  \csvreader{participants3.csv}{%
    3=\firstname,4=\lastname,26=\church,9=\postalcode,
    15=\ticket,16=\room,18=\mealA,19=\mealB,20=\mealC,21=\mealD,22=\mealE}%
  {
