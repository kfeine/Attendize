...
class CreateBelongstoAttendeeTicketOptionsDetails extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('attendee_ticket_options_details', function (Blueprint $table) {
            ...
            $table->integer('ticket_options_detail_id')->unsigned()->nullable();
            $table->foreign('ticket_options_detail_id')->references('id')->on('ticket_options_details')->onDelete('cascade');
